...
public class Driver {
	public static void main(String[] args) {
		Floor f1 = new Floor(0, false);
		Floor f2 = new Floor(1, false);
		Floor f3 = new Floor(2, false);
		Floor f4 = new Floor(3, false);
		Floor f5 = new Floor(4, false);
		Floor f6 = new Floor(5, false);
		
		
		Lift lift = new Lift("Lift 1", 120.00);
		
		ControlPanel controlPanel = new ControlPanel(lift, f1);
